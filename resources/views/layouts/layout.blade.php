...
<body class="bg-cover font-sans bg-center bg-no-repeat h-screen" style="background-image: url('images/fitness 2 image.jpg')">
    ...
    <ul class="flex items-center text-gray-100  justify-center">
        <li class="px-8 hover:text-lime-300">Home</li>
        <li class="px-8 hover:text-lime-300">Products</li>
        ...
        <li class="px-8 hover:text-lime-300">Login</li>
        <li class="px-8 hover:text-lime-300">Contact</li>
    </ul>
  </nav>
  <div>
    @yield('content')
